          ...
          <form action="login.php" method="post">
           <p class="text-center h2 fw-bold mb-4 mx-1 mx-md-3 mt-3" style="color: #830408;">PCB | Board of Trustees</p>
            ...
            <div class="form-floating mb-4">
              <input type="text" class="form-control" name="username" autocomplete="off" id="floatingInput" placeholder="Enter your username" style="border-radius: 20px ;" >
           ...
           <div class="form-floating mb-4">
            ...
            <div class="d-flex justify-content-center mx-1 mb-3 mb-lg-1">
              <input type="submit" value="Login" name="login" class="btn btn-danger btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600;" />
            </div>
